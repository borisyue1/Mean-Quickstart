...
//                 user.save();
//                 res.render('saved', {url: user.urls, success: "Successfully added link"});
//                 // res.redirect('/saved');
//            }
// 	    })
//        }
...
//        } else {
//        		User.findById(req.user._id, function(err, user){
//        			for (var s = 0; s < user.urls.length; s++) {
//        				if (foundLink._id.toString() == user.urls[s]._id.toString()) {
//        					user.urls.splice(s, 1);
//        				}
//        			}
...
// 			           	res.redirect("back");
// 			       } else {
// 			       		res.render("saved", {url: user.urls, success: "Successfully deleted link"});
// 			       }
// 			    });
//        		});
//        }
...
//SAVE FACEBOOK OR TWITTER PROFILE
